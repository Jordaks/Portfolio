<?php include_once __DIR__ . '/components/header.php'; ?>
    ...
    <!-- About Section -->
    <section id="about" class="py-24 px-4 md:px-8 lg:px-16 min-h-screen flex items-center section-fade">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col gap-4">
                <div class="flex items-center gap-2 mb-4" data-aos="fade-up">
                    <i class="fa-solid fa-user-tie text-2xl text-blue-300"></i>
                ...
                <div class="grid md:grid-cols-5 gap-8 mt-8">
                    <div class="md:col-span-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="relative">
                            <div class="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl blur-md opacity-75 pointer-events-none"></div>
                                <div class="overflow-hidden rounded-2xl border-4 border-white shadow-xl">
                                    <img src="/Portfolio/src/image/mee.jpeg" alt="Portrait of Jordi"
                                    class="w-full h-auto object-cover transition-transform duration-70000 hover:scale-105">
                                </div>
                        </div>
                    </div>

                    <div class="md:col-span-3 flex flex-col justify-between" data-aos="fade-up" data-aos-delay="200">
                        <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                            <p class="text-xl leading-relaxed text-gray-700">
                                I am a passionate and dedicated Information Technology student with a keen interest in web
                                development, programming, and technology. I enjoy learning new skills and applying them to
                                real-world projects. I am currently pursuing my degree at Batangas State University - TNEU, where I
                                am gaining valuable knowledge and experience in the field of IT.
                            </p>
                            <p class="text-xl leading-relaxed text-gray-700 mt-4">
                                In my free time, I love to explore new technologies, work on personal projects, and contribute to
                                open-source communities. I am always eager to learn and grow in my field.
                            </p>
                        </div>

                        <div class="mt-8">
                            <h3 class="text-2xl font-bold text-gray-800 mb-6" data-aos="fade-up">Skills</h3>
                            <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="100">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #E44D26;">
                                    ...
                                    <span class="mt-2 text-sm font-medium text-gray-700">HTML</span>
                                </div>
                                
                                <!-- CSS -->
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="150">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #2965F1;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" preserveAspectRatio="xMidYMid" viewBox="0 0 256 361" id="css">
                                    ...
                                    <span class="mt-2 text-sm font-medium text-gray-700">CSS</span>
                                </div>
                                
                                <!-- Tailwind -->
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="200">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #38BDF8;">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="#38BDF8" width="40" height="40" viewBox="-2.4 -2.4 28.80 28.80" xml:space="preserve" stroke="#38BDF8" stroke-width="0.00024000000000000003">
                                ...
                                <!-- PHP -->
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #6181B6;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 128 128" id="php">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="300">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #F7DF1E;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 256" id="javascript">
                                ...
                                <!-- MySQL -->
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="350">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #00618A;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 128 128" id="mysql">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="400">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #366994;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 255" id="python">
                                                <defs>
                                ...
                                <!-- Java -->
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="450">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #EA2D2E;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 128 128" id="java">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="500">
                                    <div class="group">
                                        <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300 group-hover:scale-110" style="border-top: 3px solid #5C8DBC;">
                                            <svg class="pl-0.5" xmlns="http://www.w3.org/2000/svg" width="40" height="40" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 288" id="c">
                                    ...
                                    <span class="mt-2 text-sm font-medium text-gray-700">C++</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Projects Section -->
    <section id="projects" class="py-24 px-4 md:px-8 lg:px-16 min-h-screen bg-gradient-to-b from-gray-50 to-white section-fade">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center gap-2 mb-12" data-aos="fade-up">
                <i class="fa-solid fa-code text-2xl text-blue-300"></i>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="project-card bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Portfolio Website</h3>
                        <p class="text-gray-600 mb-4">Built with HTML, CSS, and Tailwind. Responsive and clean UI.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">HTML</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">CSS</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">Tailwind</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="project-card bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Time Scheduling System</h3>
                        <p class="text-gray-600 mb-4">Final project built with Java (OOP) and MySQL.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                            ...
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">OOP</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="project-card bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Online Thrift Shop</h3>
                        <p class="text-gray-600 mb-4">Final project built with HTML, CSS, Tailwind and MySQL. Responsive and clean UI.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">HTML</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">CSS</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full">Tailwind</span>
    ...
    <section id="certificates" class="py-24 px-4 md:px-8 lg:px-16 min-h-screen bg-gradient-to-b from-white to-gray-50 section-fade">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center gap-2 mb-12" data-aos="fade-up">
                <i class="fa-solid fa-layer-group text-2xl text-blue-300"></i>
                <h2 class="text-3xl font-bold text-gray-800">Certificates</h2>
            </div>

            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                <h3 class="text-2xl font-bold text-gray-800 mb-8">Batangas Information Technology Society (BITS)</h3>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <!-- Certificate 1 -->
                    <div class="project-card backdrop-blur-3xl rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300" data-aos="fade-up" data-aos-delay="100">
                        <div class="relative overflow-hidden h-48 group border-b border-gray-500">
                            <img src="/Portfolio/src/image/cert1.jpg" alt="Portfolio Website"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 cursor-pointer"
                            onclick="openModal(this.src)">
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl pb-6 font-bold text-gray-800">DATABIZ CONFERENCE 2024</h4>
                            <p class="text-gray-600 mt-2">Theme: "Equipping Tomorrow's Innovators with Data Science, AI and Business Analytics"</p>
                        </div>
                    </div>
                        <!-- Certificate 2 -->
                    <div class="project-card backdrop-blur-3xl rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300" data-aos="fade-up" data-aos-delay="100">
                        <div class="relative overflow-hidden h-48 group border-b border-gray-500">
                            <img src="/Portfolio/src/image/cert2.jpg" alt="Portfolio Website"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 cursor-pointer"
                            onclick="openModal(this.src)">
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-bold text-gray-800">Batangas Information Technology Conference (BITCON) 2025</h4>
                            <p class="text-gray-600 mt-2">Theme: "Building a Connected Tomorrow: IoT Innovations and Beyond"</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <img id="modalImage" src="" alt="Enlarged Certificate" class="max-w-3xl max-h-[90vh] rounded-lg shadow-2xl">
