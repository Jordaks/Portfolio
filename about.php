            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid md:grid-cols-5 gap-8 mt-8">
                    <div class="md:col-span-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="relative">
                            <div class="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl blur-md opacity-75"></div>
                            <img src="/Portfolio/src/image/jordi.jpeg" alt="Portrait of Jordi" 
                                class="relative w-full h-auto object-cover rounded-2xl border-2 border-white shadow-xl">
                        </div>
                    </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="100">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #E44D26;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="150">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #2965F1;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="200">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #38BDF8;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #6181B6;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="300">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #F7DF1E;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="350">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #00618A;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="400">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #366994;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="450">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #EA2D2E;">
                                ...
                                <div class="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="500">
                                    <div class="skill-icon w-16 h-16 flex items-center justify-center rounded-xl shadow-md bg-white p-3 transition-transform duration-300" style="border-top: 3px solid #5C8DBC;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 288" id="c">
    ...
    <section id="certificates" class="py-24 px-4 md:px-8 lg:px-16 min-h-screen bg-gradient-to-b from-white to-gray-50 section-fade">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Batangas Information Technology Society (BITS)</h3>

                <div class="mt-8 space-y-8">
                    <!-- Certificate 1 -->
                    <div class="flex flex-col md:flex-row gap-6 p-6 rounded-xl hover:bg-gray-50 transition-colors border border-gray-100 shadow-sm" data-aos="fade-up" data-aos-delay="150">
                        <div class="flex-shrink-0 w-16 h-16 bg-blue-200 rounded-lg flex items-center justify-center">
                            <span class="text-blue-500 font-bold">2024</span>
                        </div>
                        <div>
                            <h4 class="text-xl font-bold text-gray-800">DATABIZ CONFERENCE 2024</h4>
                            <p class="text-gray-600 mt-2">Theme: "Equipping Tomorrow's Innovators with Data Science, AI and Business Analytics"</p>
                        </div>
                    </div>

                    <!-- Certificate 2 -->
                    <div class="flex flex-col md:flex-row gap-6 p-6 rounded-xl hover:bg-gray-50 transition-colors border border-gray-100 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex-shrink-0 w-16 h-16 bg-blue-200 rounded-lg flex items-center justify-center">
                            <span class="text-blue-500 font-bold">2025</span>
                        </div>
                        <div>
