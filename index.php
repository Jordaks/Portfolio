<?php include_once __DIR__ . '/components/header.php'; ?>
    ...
    <section id="about" class="p-20 bg-opacity-10 min-h-screen relative">
        <div class="px-6">

            <h2 class="text-3xl font-bold pb-5">About Me</h2>
            <div class="flex items-start mt-8 border-2 border-white p-6 rounded-2xl text-black bg-white shadow-lg group">
                <img 
